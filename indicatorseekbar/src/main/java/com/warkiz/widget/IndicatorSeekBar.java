...
public class IndicatorSeekBar extends View {
    ...
    //tick texts
    public boolean mShowTickText;//the palace where the tick text show .
    ...
    private void initParams() {
        ...
        initStrokePaint();
        // --- 修改开始 ---
        // 总是初始化 TextPaint 和 Rect，即使不显示文字
        initTextPaint();
        measureTickTextsBonds(); // 这个方法内部也会调用 initTextPaint()，确保安全
        // --- 修改结束 ---
    ...
    public Drawable getTickMarksDrawable() {
        return mTickMarksDrawable;
    }
    public int getTrackColor() {
        return mBackgroundTrackColor;
    }
    public void setTrackColorInactive(@ColorInt int trackColor) {
        this.mBackgroundTrackColor = trackColor;
        invalidate();
    }
    public void setTrackColorActive(@ColorInt int trackColor) {
        this.mProgressTrackColor = trackColor;
        invalidate();
    }
